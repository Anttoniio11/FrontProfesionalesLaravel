...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/CitasProgramadasUsuario.css') }}">
    ...
    <section class="comments-section">
        <div class="comment">
            ...
            <div class="comment-info">
                <h3>Macalister Silva # 0808</h3>
                <p><b>Profesional:</b> Diego Armando Maradona</p>
                <div class="fecha-hora">
                    <p><b>Fecha:</b> 2023-07-16</p>
                    <p><b>Hora:</b> 14:30</p>
                </div>
            </div>
            <a href="../Consulta_Usuario/ConsultaUsuario.html" class="cancel">
                <img src="../Imagenes/Acceder.png" alt="Cancelar cita">
                <h3>Acceder a cita</h3>
            </a>
        </div>
        <div class="comment">
            <img class="imagen-usuario" src="{{ asset('img/Imagenes/FotoUsuario.png') }}" alt="Foto de perfil del usuario">
